...
def get_loss_function(reg_lambda=1.0):
    """
    Returns a loss function that combines L1 loss with KL divergence regularization.
    Args:
        reg_lambda: Weight of the KL regularization term (default: 1.0)
    Returns:
    ...
    def combined_loss(pred, target, model, g):
        ...
        n = g.x.size(0)
        reg_term = reg_lambda * batch_size * full_kl / (n**2) * n
